  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-8 flex flex-col gap-6 text-gray-700">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900">What we do not collect</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900">Who can see what</h2>
          <ul className="mt-3 flex list-disc flex-col gap-2 pl-6">
            <li>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900">Who processes it for us</h2>
          <p className="mt-3">
